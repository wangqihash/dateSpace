...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _views = __webpack_require__(333);
	...
	var _yquery = __webpack_require__(332);

	var _yquery2 = _interopRequireDefault(_yquery);

	var _eventUtil = __webpack_require__(337);
	...
	var Home = function (_mix) {
	    ...
	    return Home;
	}(mix(_views2.default, _login2.default, _base2.default, _interface2.default));
	...
	var Views = function () {
	    ...
	    _createClass(Views, [{
	        ...
	        value: function getDetail(event) {
	            var title = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '123';
	            var content = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '234';

	            var tpl = '\n                <h2>' + title + '</h2>\n                <div>' + content + '</div>\n            ';
	            alert('1');
	            (0, _yquery2.default)('.container').html(tpl);
	        }
	    }]);
